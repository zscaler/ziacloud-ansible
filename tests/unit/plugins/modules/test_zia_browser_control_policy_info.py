...
class TestBrowserControlPolicyinfoModule(ModuleTestCase):
    @pytest.fixture
    def mock_client(self):
        with patch("ansible_collections.zscaler.ziacloud.plugins.modules.zia_browser_control_policy_info.ZIAClientHelper") as mock_class:
    ...
    def test_list_or_get(self, mock_client):
        ...
        with pytest.raises(AnsibleExitJson) as result:
            zia_browser_control_policy_info.main()

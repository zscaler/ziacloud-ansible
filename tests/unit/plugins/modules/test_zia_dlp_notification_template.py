...
class TestDlpNotificationTemplateModule(ModuleTestCase):
    ...
    def mock_client(self):
        with patch("ansible_collections.zscaler.ziacloud.plugins.modules.zia_dlp_notification_template.ZIAClientHelper") as mock_class:
            ...
            client_instance.dlp_templates.add_dlp_template.return_value = (MockBox({'id': 1, 'name': 'test', 'whitelist_urls': [], 'blacklist_urls': []}), None, None)
            client_instance.dlp_templates.delete_dlp_template.return_value = (MockBox({'id': 1, 'name': 'test', 'whitelist_urls': [], 'blacklist_urls': []}), None, None)
            ...
            client_instance.dlp_templates.update_dlp_template.return_value = (MockBox({'id': 1, 'name': 'test', 'whitelist_urls': [], 'blacklist_urls': []}), None, None)
